...
Sub2API 将 OpenAI 兼容能力作为平台内建功能统一提供，包括 `/v1/responses`、`/v1/chat/completions` 和 `/v1/embeddings`。这些接口共享同一套 API Key、会员/订阅校验、账号调度、用量记录与计费链路，而不是依赖独立旁路服务。
