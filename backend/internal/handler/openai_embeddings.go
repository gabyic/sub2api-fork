...
func (h *OpenAIGatewayHandler) Embeddings(c *gin.Context) {
	...
	for {
		...
		result, err := h.gatewayService.ForwardAsEmbeddings(c.Request.Context(), c, account, body)
		...
		if err == nil {
			...
			h.submitUsageRecordTask(func(ctx context.Context) {
				if err := h.gatewayService.RecordUsage(ctx, &service.OpenAIRecordUsageInput{
					...
					InboundEndpoint:  normalizedOpenAIInboundEndpoint(c, openAIInboundEndpointEmbeddings),
					UpstreamEndpoint: normalizedOpenAIUpstreamEndpoint(c, openAIUpstreamEndpointEmbeddings),
					UserAgent:        userAgent,
					IPAddress:        clientIP,
